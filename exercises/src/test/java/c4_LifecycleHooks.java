...
public class c4_LifecycleHooks extends LifecycleHooksBase {
    ...
    public void no_subscription_no_gains() {
        ...
        Flux<Integer> temperatureFlux = room_temperature_service().doOnSubscribe(
                subscription -> hooksTriggered.add("subscribe"));
    ...
    public void be_there_early() {
        ...
        Flux<Integer> temperatureFlux = room_temperature_service().doOnSubscribe(
                subscription -> hooksTriggered.add("before subscribe")
        );
    ...
    public void atomic_counter() {
        ...
        Flux<Integer> temperatureFlux = room_temperature_service().doOnNext(
                integerSignal -> {
